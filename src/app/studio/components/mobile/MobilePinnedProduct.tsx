            ...
            {isExpanded && (
                ...
                >
                    ...
                    {isFlashProduct && flashUrgency === "critical" && (
                        <>
                            <div className="absolute inset-0 border-[3px] border-red-500 rounded-2xl animate-pulse shadow-[0_0_15px_rgba(239,68,68,0.8)] pointer-events-none z-20" />
                            <div className="absolute inset-[-4px] border border-red-400/30 rounded-[20px] animate-ping opacity-20 pointer-events-none" />
                        </>
                    )}
                </div>
            )}
