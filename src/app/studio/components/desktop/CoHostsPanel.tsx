                ...
                {coHosts.map((c) => (
                    <div key={c.id} className="flex items-center justify-between text-[10px]">
                        <div className="flex items-center gap-2 min-w-0">
                            <span className="h-6 w-6 rounded-full bg-muted flex items-center justify-center text-[10px] text-foreground">
                        ...
                        <div className="flex items-center gap-1">
                            <button className="px-2 py-0.5 rounded-full border border-border text-foreground text-[9px]" onClick={() => alert("Accept (demo)")}>Accept</button>
                            <button className="px-2 py-0.5 rounded-full border border-border text-muted-foreground text-[9px]" onClick={() => alert("Remove (demo)")}>Remove</button>
                        </div>
                    </div>
                ))}
            </div>
