...
import { BuyerAgent, Product } from "../shared/types";
import { formatHMS, fmtMoneyUSD, mockTranslate } from "../shared/utils";
import { EV_ORANGE, EV_GREEN } from "../shared/constants";
