                ...
                {products.map((p) => {
                    ...
                    return (
                        <div
                            ...
                            role="button"
                            tabIndex={0}
                            className={`w-full text-left border rounded-xl px-2.5 py-1.5 flex flex-col gap-0.5 cursor-pointer ${active ? "bg-[#f77f00]/10 border-[#f77f00] text-slate-50" : "bg-slate-950 border-slate-800 text-slate-200 hover:border-slate-600"}`}
